...
public class Binary
{
	...
	*/
	...
	public static Binary mul(Binary num1, Binary num2) {
		...
		int shift = 0; // Tracks the position of the current bit in num2
	
		// Process each bit of num2
		for (int i = num2.number.length() - 1; i >= 0; i--) { //loops from least sig digit of num 2
			if (num2.number.charAt(i) == '1') {
				// Shift num1 left by the current bit position and add to the result
